...
section .data
    message db 'KI-231 Pozdniak', 0Ah, 0 ; Повідомлення з символом переведення рядка
...
main:
    ...
    call GetStdHandle        ; Зберігаємо дескриптор виводу
    ...
    mov r8, 17               ; nNumberOfCharsToWrite (достовірна довжина рядка)
